...
bot = telepot.Bot('121899714:AAGAp0rdqSbqzP8-j1wqnUfWJ-lx-L9NLrQ')  #设置密匙(访问令牌)，没有请@BotFather
...
def handle_message(msg):  #这个函数用来接收新信息
       ...
       print(type(str(msg[u'chat'][u'id'])))  #输出聊天id
       print(type(msg[u'text']))  #输出消息内容
