...
result = py_run('C:\\Users\\Administrator\\Desktop\\codes\\Programming\\TRY\\E_py\\config\\codes.py')
try:
    f = open('C:\\Users\\Administrator\\Desktop\\codes\\Programming\\TRY\\E_py\\config\\result.txt', 'w')
    f.write(result)
    f.close()
except:
    print('error')
