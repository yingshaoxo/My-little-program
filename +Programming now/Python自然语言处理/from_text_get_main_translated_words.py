...
def from_text_get_main_translated_words(text):
    return all_translate(get_words_list(filter_some_types(tag(text))))
...
cattle."""
text2 = 'In the early days of the settlement of Australia, enterprising settlers unwisely introduced the European rabbit.'
